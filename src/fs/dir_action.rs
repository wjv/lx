...
/// directory.
///
/// By default, lx will display the information about files passed in as
/// command-line arguments, with one file per entry. However, if a directory
/// is passed in, lx assumes that the user wants to see its contents, rather
/// than the directory itself.
///
/// This can get annoying sometimes: if a user does `lx ~/Downloads/img-*`
...
/// modes. Here, instead of just listing the directories, lx will descend
