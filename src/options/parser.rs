...
Environment variables:\n  \
  ...
  TIME_STYLE       Default timestamp style (overridden by --time-style)")
        ...
        .arg(Arg::new(flags::IGNORE_GLOB)
            ...
            .help("Glob patterns (pipe-separated) of files to hide completely")
            .action(ArgAction::Set)
            .value_name("GLOB"))
        .arg(Arg::new(flags::PRUNE)
            .short('P').long("prune")
            .visible_alias("prune-glob")
            .help("Glob patterns (pipe-separated) of directories to show but not recurse into")
            .action(ArgAction::Set)
            .value_name("GLOB"))
        ...
        .arg(Arg::new("dump-class")
            .long("dump-class")
            .help("Dump file-type class definitions as TOML and exit")
            .value_name("NAME")
        ...
        .arg(Arg::new("dump-format")
            .long("dump-format")
            .help("Dump format definitions as TOML and exit")
            .value_name("NAME")
            .default_missing_value("")
            .num_args(0..=1)
            .require_equals(true))
        .arg(Arg::new("dump-personality")
            ...
            .help("Dump personality definitions as TOML and exit")
            .value_name("NAME")
            .default_missing_value("")
            .num_args(0..=1)
            .require_equals(true))
        .arg(Arg::new("dump-theme")
            .long("dump-theme")
            .help("Dump theme definitions as TOML and exit")
            .value_name("NAME")
            .default_missing_value("")
            .num_args(0..=1)
            .require_equals(true))
        .arg(Arg::new("dump-style")
            .long("dump-style")
            .help("Dump style definitions as TOML and exit")
            .value_name("NAME")
            .default_missing_value("")
            .num_args(0..=1)
            .require_equals(true))
        ...
        .arg(Arg::new("upgrade-config")
            .long("upgrade-config")
            .help("Upgrade a legacy config file to the current format")
            .action(ArgAction::SetTrue)
            .hide(true))
